			...
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						...
						<?php
							include('../db.php');
							$result = mysqli_query($bd, "SELECT * FROM customer");
							while($row = mysqli_fetch_array($result))
								{
									...
									$results = mysqli_query($bd, "SELECT * FROM route WHERE id='$rrad'");
									...
									$resulta = mysqli_query($bd, "SELECT * FROM reserve WHERE transactionnum='$dddd'");
