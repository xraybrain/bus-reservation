...
<div id="wrapper">
	<div id="header">
    <h5><a href="index.php"><img src="xres/images/logos.png" class="logo" alt="James Buchanan Pub and Restaurant" /></a></h5>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/011.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/022.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/033.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/044.jpg" width="861" height="379"  alt="" /></li>
              </ul>
			  ...
			  <div id="logo" style="left: 600px; height: auto; top: 23px; width: 260px; position: absolute; z-index:4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						...
						<?php
						include('db.php');
						$result = mysqli_query($bd, "SELECT * FROM route");
